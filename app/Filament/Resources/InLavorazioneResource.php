...
use App\Filament\Resources\InLavorazioneResource\Pages;
...
class InLavorazioneResource extends Resource
{
    ...
    // Query per mostrare SOLO gli aggiusti in lavorazione
    ...
    public static function table(Table $table): Table
    {
        ...
        ->toggleable(),
                ...
                Tables\Actions\Action::make('completa')
                    ...
                    ->action(function ($record) {
                        ...
                        \Filament\Notifications\Notification::make()
                            ...
                            ->body("L'aggiusto per {$record->customer->name} è stato completato.")
                            ->success()
                            ->send();
                    }),
            ])
            ...
            ->emptyStateHeading('Nessun aggiusto in lavorazione')
            ->emptyStateDescription('Tutti i lavori sono stati completati!')
    ...
    {
        return [
            'index' => Pages\ListInLavoraziones::route('/'),
            'view' => Pages\ViewInLavorazione::route('/{record}'),
            'edit' => Pages\EditInLavorazione::route('/{record}/edit'),
        ];
    }
