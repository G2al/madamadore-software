    ...
    <table style="width: 100%; border-collapse: collapse; table-layout: fixed; height: 236mm;">
        <tr>
            <td style="width: 33.33%; vertical-align: top; padding-right: 4mm; border-right: 1px solid #e0d7d1;">
                ...
                <div class="small-text" style="min-height: 74mm; line-height: 1.38;">
                ...
                <div class="small-text" style="line-height: 1.36;">
            ...
            <td style="width: 33.33%; vertical-align: top; padding: 0 4mm; border-right: 1px solid #e0d7d1;">
                ...
                <div class="small-text" style="min-height: 126mm; line-height: 1.42;">
                ...
                <div class="small-text" style="line-height: 1.42;">
            ...
            <td style="width: 33.34%; vertical-align: top; padding-left: 4mm;">
                ...
                <table class="grid-table small-text" style="font-size: 7.4px;">
                    <tr>
                        <th>Tessuto</th>
                ...
                <div class="section-title" style="margin-top: 6mm;">Campioni tessuto</div>
                @for($i = 0; $i < 3; $i++)
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 4mm;">
                        <tr>
                            <td style="width: 42%; vertical-align: top; padding-right: 3mm;">
                                <div class="sample-image" style="height: 26mm;">
